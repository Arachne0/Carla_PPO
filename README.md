...
We have used [CALRA](http://carla.org/) (version 0.9.14) as our environment (Urban Simulator). We have also summarized some results and analyses to simplify this problem further.
